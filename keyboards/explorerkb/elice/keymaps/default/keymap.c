...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, XXXXXXX, KC_LALT, KC_SPC,  MO(1),             XXXXXXX, MO(1),   KC_SPC,  KC_RALT,          XXXXXXX, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
        ),
    [1] = LAYOUT(
        ...
        KC_TRNS, KC_LGUI, KC_TRNS, KC_TRNS, KC_TRNS,           XXXXXXX, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS
        ),
    [2] = LAYOUT(
